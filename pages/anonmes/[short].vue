<template>
    <div>
        <div class="container">
            <h2 class="text-black text-2xl mx-1 font-extrabold  relative inline-block stroke-current">💁 AnonMess: {{ anonmes?.anlink?.author }} <svg
            ...
            <div class="bg-blue-300 p-2 text-black m-2">
                Send your private message to <b class="text-black">{{ anonmes?.anlink?.author }}</b> by writing in the box below !
            </div>
           
            <div class="w-2/3 mx-auto">
                <textarea class="p-2 border-2 border-black w-full mt-4 focus:border-gray-400 focus:shadow-md hover:border-amber-900" v-model="message" placeholder="Your Message"></textarea>
            <button class="mt-4 p-2 bg-black text-white  hover:bg-gray-600 w-full" type="button" @click="sendMessage">Send</button>
            </div>
            ...
            <span class="text-white shadow">📆  Date</span>
            </div>
