<template>
  ...
  <section>
    <div class="w-full px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 max-w-7xl mx-auto">
     
        <div class="mx-auto  text-center p-2 md:p-10 lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
          <h2 class="text-3xl font-bold sm:text-4xl">Who's Behind the Keyboard? 👇</h2>

          <p class="mt-4 text-gray-600">
            Meet Alin Koko Mansuby, a software engineer who crafts exceptional web experiences. With years of experience
            tackling diverse projects, Alin's expertise spans both full-stack and backend development, with a
            specialization in the intricacies of web development.
          </p>


        </div>
        <h2 class="text-3xl font-bold sm:text-2xl">Tech stack ⚒️</h2>
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-6">
          ...
          <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            ...
            <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">Expert</p>
          </a>
          ...
          <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            ...
            <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">Advance</p>
          </a>
          ...
          <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            ...
            <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">Medior</p>
          </a>
          ...
          <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            ...
            <p class="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">Junior</p>
          </a>
          <a class="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring"
            href="#">
            <span class="inline-block rounded-lg bg-gray-50 p-3">
        ...
        <h2 class="text-3xl font-bold sm:text-2xl mt-5">Powerfull Tools 🔨</h2>
