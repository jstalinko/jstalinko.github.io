<template>
  ...
  <text x="50" y="50" font-size="20" class="space-grotesk" fill="#007bff" stroke="#000" stroke-width="1">&lt;justalinko/&gt;</text> 
</svg>
            </div>
          ...
          >
            ...
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#project"> Projects </a>
            </li>
            ...
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="http://blog.justalinko.com" target="_blank"> Blog </a>
            </li>
          </ul>
        </div>
    
        <p class="mt-12 text-center text-sm text-gray-500 lg:text-right">
          Crafted with Nuxt.js by alinko | copyright &copy; {{ new Date().getFullYear() }}
        </p>
      </div>
    </footer>
  </template>